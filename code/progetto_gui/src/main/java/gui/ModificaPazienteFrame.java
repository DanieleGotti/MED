...
/**
 * Classe contenente il frame per gestire la modifica dei dati del paziente nelle sezioni "In Pronto Soccorso" e "Da Prendere in Carico"
 * contiene solo parte grafica, è resa utilizzabile dal progetto_logico
 * sono stati utilizzati java swing e WindowBuilder
 */
public class ModificaPazienteFrame {
    ...
    public ModificaPazienteFrame() {
        ...
        scrollContentPanel.setPreferredSize(new Dimension(470, 532));
        ...
        urgenzaLabel.setBounds(30, yPosition, 436, 30);
        urgenzaLabel.setForeground(Color.GRAY);
        urgenzaLabel.setFont(Stile.TESTO.getFont());
        scrollContentPanel.add(urgenzaLabel);
        yPosition += 33;
        ...
        urgenzaComboBox.setBounds(30, yPosition, 436, 30);
        scrollContentPanel.add(urgenzaComboBox);
        yPosition += 33;
