...
public class InserisciVisitaFrame {
	...
	public InserisciVisitaFrame() {
		...
		sfondoFrame.setTitle("<html><font color='white'>M.E.D Inserisci visita</font></html>");
		...
		avantiButton.setBounds(346, 436, 120, 30);
		...
		inserisciVisitaPanel.add(avantiButton);
