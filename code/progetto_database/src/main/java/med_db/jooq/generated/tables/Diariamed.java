...
public class Diariamed extends TableImpl<DiariamedRecord> {
    ...
    /**
     * The column <code>DIARIAMED.COUNT_DEGENTE</code>.
     */
    public final TableField<DiariamedRecord, Integer> COUNT_DEGENTE = createField(DSL.name("COUNT_DEGENTE"), SQLDataType.INTEGER, this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function11<? super Integer, ? super String, ? super Integer, ? super String, ? super String, ? super String, ? super String, ? super String, ? super LocalDate, ? super LocalTime, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function11<? super Integer, ? super String, ? super Integer, ? super String, ? super String, ? super String, ? super String, ? super String, ? super LocalDate, ? super LocalTime, ? super String, ? extends U> from) {
