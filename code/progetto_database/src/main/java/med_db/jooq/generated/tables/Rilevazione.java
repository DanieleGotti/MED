...
public class Rilevazione extends TableImpl<RilevazioneRecord> {
    ...
    /**
     * The column <code>RILEVAZIONE.COUNT_DEGENTE</code>.
     */
    public final TableField<RilevazioneRecord, Integer> COUNT_DEGENTE = createField(DSL.name("COUNT_DEGENTE"), SQLDataType.INTEGER, this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function12<? super Integer, ? super String, ? super Integer, ? super String, ? super Double, ? super Integer, ? super Integer, ? super Integer, ? super LocalDate, ? super LocalTime, ? super Integer, ? super Integer, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function12<? super Integer, ? super String, ? super Integer, ? super String, ? super Double, ? super Integer, ? super Integer, ? super Integer, ? super LocalDate, ? super LocalTime, ? super Integer, ? super Integer, ? extends U> from) {
