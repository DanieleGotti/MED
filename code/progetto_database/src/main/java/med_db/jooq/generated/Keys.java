...
public class Keys {
    ...
    public static final UniqueKey<AssegnazionelettoRecord> ASSEGNAZIONELETTO__PK_ASSEGNAZIONELETTO = Internal.createUniqueKey(Assegnazioneletto.ASSEGNAZIONELETTO, DSL.name("pk_ASSEGNAZIONELETTO"), new TableField[] { Assegnazioneletto.ASSEGNAZIONELETTO.CODICE_REPARTO, Assegnazioneletto.ASSEGNAZIONELETTO.CODICE_DEGENTE, Assegnazioneletto.ASSEGNAZIONELETTO.COUNT_DEGENTE, Assegnazioneletto.ASSEGNAZIONELETTO.NOME_MODULO, Assegnazioneletto.ASSEGNAZIONELETTO.NUMERO_LETTO }, true);
    public static final UniqueKey<DegenteRecord> DEGENTE__PK_DEGENTE = Internal.createUniqueKey(Degente.DEGENTE, DSL.name("pk_DEGENTE"), new TableField[] { Degente.DEGENTE.CODICE, Degente.DEGENTE.COUNT }, true);
    public static final UniqueKey<DiariainfRecord> DIARIAINF__PK_DIARIAINF = Internal.createUniqueKey(Diariainf.DIARIAINF, DSL.name("pk_DIARIAINF"), new TableField[] { Diariainf.DIARIAINF.CODICE, Diariainf.DIARIAINF.CODICE_DEGENTE, Diariainf.DIARIAINF.COUNT_DEGENTE }, true);
    public static final UniqueKey<DiariamedRecord> DIARIAMED__PK_DIARIAMED = Internal.createUniqueKey(Diariamed.DIARIAMED, DSL.name("pk_DIARIAMED"), new TableField[] { Diariamed.DIARIAMED.CODICE, Diariamed.DIARIAMED.CODICE_DEGENTE, Diariamed.DIARIAMED.COUNT_DEGENTE }, true);
    public static final UniqueKey<DimessoRecord> DIMESSO__PK_DIMESSO = Internal.createUniqueKey(Dimesso.DIMESSO, DSL.name("pk_DIMESSO"), new TableField[] { Dimesso.DIMESSO.ID }, true);
    ...
    public static final UniqueKey<RilevazioneRecord> RILEVAZIONE__PK_RILEVAZIONE = Internal.createUniqueKey(Rilevazione.RILEVAZIONE, DSL.name("pk_RILEVAZIONE"), new TableField[] { Rilevazione.RILEVAZIONE.ID, Rilevazione.RILEVAZIONE.CODICE_DEGENTE, Rilevazione.RILEVAZIONE.COUNT_DEGENTE }, true);
    public static final UniqueKey<VisitaInterventoRecord> VISITA_INTERVENTO__PK_VISITA_INTERVENTO = Internal.createUniqueKey(VisitaIntervento.VISITA_INTERVENTO, DSL.name("pk_VISITA_INTERVENTO"), new TableField[] { VisitaIntervento.VISITA_INTERVENTO.ID }, true);

    // -------------------------------------------------------------------------
    // FOREIGN KEY definitions
    // -------------------------------------------------------------------------

    public static final ForeignKey<AssegnazionelettoRecord, DegenteRecord> ASSEGNAZIONELETTO__FK_ASSEGNAZIONELETTO_PK_DEGENTE = Internal.createForeignKey(Assegnazioneletto.ASSEGNAZIONELETTO, DSL.name("fk_ASSEGNAZIONELETTO_pk_DEGENTE"), new TableField[] { Assegnazioneletto.ASSEGNAZIONELETTO.COUNT_DEGENTE, Assegnazioneletto.ASSEGNAZIONELETTO.CODICE_DEGENTE }, Keys.DEGENTE__PK_DEGENTE, new TableField[] { Degente.DEGENTE.COUNT, Degente.DEGENTE.CODICE }, true);
    ...
    public static final ForeignKey<DiariainfRecord, DegenteRecord> DIARIAINF__FK_DIARIAINF_PK_DEGENTE = Internal.createForeignKey(Diariainf.DIARIAINF, DSL.name("fk_DIARIAINF_pk_DEGENTE"), new TableField[] { Diariainf.DIARIAINF.COUNT_DEGENTE, Diariainf.DIARIAINF.CODICE_DEGENTE }, Keys.DEGENTE__PK_DEGENTE, new TableField[] { Degente.DEGENTE.COUNT, Degente.DEGENTE.CODICE }, true);
    public static final ForeignKey<DiariamedRecord, DegenteRecord> DIARIAMED__FK_DIARIAMED_PK_DEGENTE = Internal.createForeignKey(Diariamed.DIARIAMED, DSL.name("fk_DIARIAMED_pk_DEGENTE"), new TableField[] { Diariamed.DIARIAMED.COUNT_DEGENTE, Diariamed.DIARIAMED.CODICE_DEGENTE }, Keys.DEGENTE__PK_DEGENTE, new TableField[] { Degente.DEGENTE.COUNT, Degente.DEGENTE.CODICE }, true);
    public static final ForeignKey<DimessoRecord, DegenteRecord> DIMESSO__FK_DIMESSO_PK_DEGENTE = Internal.createForeignKey(Dimesso.DIMESSO, DSL.name("fk_DIMESSO_pk_DEGENTE"), new TableField[] { Dimesso.DIMESSO.COUNT_DEGENTE, Dimesso.DIMESSO.CODICE_DEGENTE }, Keys.DEGENTE__PK_DEGENTE, new TableField[] { Degente.DEGENTE.COUNT, Degente.DEGENTE.CODICE }, true);
    ...
    public static final ForeignKey<RilevazioneRecord, DegenteRecord> RILEVAZIONE__FK_RILEVAZIONE_PK_DEGENTE = Internal.createForeignKey(Rilevazione.RILEVAZIONE, DSL.name("fk_RILEVAZIONE_pk_DEGENTE"), new TableField[] { Rilevazione.RILEVAZIONE.COUNT_DEGENTE, Rilevazione.RILEVAZIONE.CODICE_DEGENTE }, Keys.DEGENTE__PK_DEGENTE, new TableField[] { Degente.DEGENTE.COUNT, Degente.DEGENTE.CODICE }, true);
    public static final ForeignKey<VisitaInterventoRecord, DegenteRecord> VISITA_INTERVENTO__FK_VISITA_INTERVENTO_PK_DEGENTE = Internal.createForeignKey(VisitaIntervento.VISITA_INTERVENTO, DSL.name("fk_VISITA_INTERVENTO_pk_DEGENTE"), new TableField[] { VisitaIntervento.VISITA_INTERVENTO.COUNT_DEGENTE, VisitaIntervento.VISITA_INTERVENTO.CODICE_DEGENTE }, Keys.DEGENTE__PK_DEGENTE, new TableField[] { Degente.DEGENTE.COUNT, Degente.DEGENTE.CODICE }, true);
}
