...
public class Degente extends TableImpl<DegenteRecord> {
    ...
    /**
     * The column <code>DEGENTE.COUNT</code>.
     */
    public final TableField<DegenteRecord, Integer> COUNT = createField(DSL.name("COUNT"), SQLDataType.INTEGER, this, "");
    ...
    /**
     * The column <code>DEGENTE.GENERE</code>.
     */
    public final TableField<DegenteRecord, String> GENERE = createField(DSL.name("GENERE"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>DEGENTE.ETA</code>.
     */
    public final TableField<DegenteRecord, Integer> ETA = createField(DSL.name("ETA"), SQLDataType.INTEGER, this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function11<? super String, ? super Integer, ? super String, ? super String, ? super String, ? super String, ? super Integer, ? super LocalDate, ? super LocalTime, ? super String, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function11<? super String, ? super Integer, ? super String, ? super String, ? super String, ? super String, ? super Integer, ? super LocalDate, ? super LocalTime, ? super String, ? super String, ? extends U> from) {
