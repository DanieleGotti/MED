...
public class LogicaBottoneDimetti extends LogicaBottone{
	...
	protected void start() {
		    ...
		    public void actionPerformed(ActionEvent e) {
		        if(modello.modelloGestorePaziente.qualcunoSelezionato()) {
		            if (modello.modelloGestoreUtente.getMansioneUtente().equals("Medico")) {
		                ...
		                new ConfermaDimettiPaziente(frame, frameDeiPazienti, modello, carica);
		            } else {
		...
		frameDeiPazienti.dimettiButton1.addActionListener(listener);
		frameDeiPazienti.dimettiButton2.addActionListener(listener);
		frameDeiPazienti.dimettiButton3.addActionListener(listener);
		frameDeiPazienti.dimettiButton4.addActionListener(listener);
	}
}
