						...
						SwingUtilities.invokeLater(new Runnable() {
						    ...
						    public void run() {
								if (InserimentoJooq.getIstanza().assegnazioneLetto(modello.modelloGestorePaziente.getCodice(),modello.modelloGestorePaziente.getCount(),codiceReparto,modulo,letto,LocalDate.now())==1) {
									RimozioneJooq.getIstanza().assegnazioneLetto(modello.modelloGestorePaziente.getCodice(),modello.modelloGestorePaziente.getCount() ,codiceRepartoOld, moduloOld, lettoOld);
