...
public class ConfermaModificaPazienteV2 {

	private ModificaPazienteNoUrgenzaFrame frame;
	 ...
	 */
	public ConfermaModificaPazienteV2(ModificaPazienteNoUrgenzaFrame v1, PazientiFrame v2, ModelloGestoreLogicaGenerale m, LogicaCaricaPdf c) {
		frame = v1;
		frameDeiPazienti = v2;
		modello = m;
		carica = c;
			...
			public void actionPerformed(ActionEvent e) {
						...
						String genere = frame.genereTextField.getText();
							...
							if (etaTest.matches("\\d+")) {
								...
								carica.salvaConTrascinamento("Fototessera.png",false);
