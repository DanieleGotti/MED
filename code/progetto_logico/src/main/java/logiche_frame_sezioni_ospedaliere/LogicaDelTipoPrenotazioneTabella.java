...
public class LogicaDelTipoPrenotazioneTabella extends LogicaFrame{
	 ...
	 */
	public LogicaDelTipoPrenotazioneTabella(PazientiFrame p, ModelloGestoreLogicaGenerale m, String filtro) {
		super(p,m);
		this.filtro=filtro;
	}
